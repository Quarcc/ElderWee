            ...
            <div className="col-lg-5">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col">
                      <button className="super-specific-button-that-brandon-wont-use" onClick={() => navigate('/topup')}>Top Up</button>
                    </div>
                    <div className="col">
                      <button className="super-specific-button-that-brandon-wont-use" onClick={() => navigate('/transfer')}>Transfer</button>
                    </div>
                  </div>
                </div>
              </div>
